...
/***********************************************************************************************************************
* Function Name: CMP_Hy_Setting
* @brief  This function sets the Hy edge and voltage.
* @param  ch - specify the comp channel number
* @param  mode - specify the edge of hy 
* @param  val - specify the voltage of hy
* @return None
***********************************************************************************************************************/
void CMP_Hy_Setting(cmp_channel_t ch, cmp_hymode_t mode, cmp_hyval_t val)
{
    if(ch & 0x01)
    {
        CMP->CMP0HY = mode << 0 | val << 4;
    }
    if(ch & 0x02)
    {
        CMP->CMP1HY = mode << 0 | val << 4;
    }
}
/***********************************************************************************************************************
