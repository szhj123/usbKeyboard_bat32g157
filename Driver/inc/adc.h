...
#define _23_AD_INPUT_PGA0                       (0x23U) /* ANI35 */
#define _24_AD_INPUT_DP                         (0x24U) /* ANI36 */
#define _25_AD_INPUT_DM                         (0x25U) /* PGAO of PGA0 is used to be the input channel */
//#define _26_AD_INPUT_PGA1                       (0x26U) /* PGAO of PGA1 is used to be the input channel */
#define _26_AD_INPUT_CHANNEL_OFF                (0x3FU) /* ANIx OFF */
...
uint16_t ADC_Converse_Scan(adc_channel_t ch, adc_scan_t scannum, uint32_t sz, uint16_t *buf);
