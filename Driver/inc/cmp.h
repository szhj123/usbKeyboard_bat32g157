...
typedef enum 
{
    CMP_PSIDE_VCIN0 = 0U,   	// P22
    CMP_PSIDE_PGAO  = 1U,     	// PGA0OUT
    CMP_NSIDE_IVREF  = 0U,     	// internal voltage reference
    CMP_NSIDE_BGR   = 1U,     	// BGR output reference voltage
    CMP_NSIDE_EVREF  = 2U,   	// P147
    CMP_PSIDE_VCIN10   = 0U,   	// P00
    CMP_PSIDE_VCIN11   = 1U, 	// P01
    CMP_PSIDE_VCIN12   = 2U, 	// P20
    CMP_PSIDE_VCIN13   = 3U, 	// P21
    CMP_NSIDE_VCIN10   = 2U,    // P00
    CMP_NSIDE_VCIN11   = 3U,  	// P01
    CMP_NSIDE_VCIN12   = 4U,  	// P20
    CMP_NSIDE_VCIN13   = 5U   	// P21
} cmp_side_t;
...
typedef enum 
{
    CMP_HYEDGE_NONE    = 0U,  // None Hy
    CMP_HYEDGE_RISING  = 1U,  // Comparator Hy at risting edge
    CMP_HYEDGE_FALLING = 2U,  // Comparator Hy at falling edge    
    CMP_HYEDGE_BOTH    = 3U   // Comparator Hy at both edge
} cmp_hymode_t;

typedef enum 
{
    CMP_HYVAL_NONE    = 0U,  // None Hy
    CMP_HYVAL_20mv    = 1U,  // Comparator Hy 20mV
    CMP_HYVAL_40mv    = 2U,  // Comparator Hy 40mV    
    CMP_HYVAL_60mv    = 3U   // Comparator Hy 60mV
} cmp_hyval_t;
...
void CMP_Hy_Setting(cmp_channel_t ch, cmp_hymode_t mode, cmp_hyval_t val);
