...
#define _0006_SCI_LENGTH_7                      (0x0006U) /* 7-bit data length */
#define _0007_SCI_LENGTH_8                      (0x0007U) /* 8-bit data length */
#define _0008_SCI_LENGTH_9                      (0x0008U) /* 9-bit data length */
#define _000F_SCI_LENGTH_16                     (0x000FU) /* 16-bit data length */
