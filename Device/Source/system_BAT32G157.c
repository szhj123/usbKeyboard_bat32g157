...
const uint8_t user_opt_data[8] __attribute__((used)) __attribute__((section(".ARM.__AT_0x080000C0"))) =
{
 ...
 *     7    |    6    |    5    |    4    |    3    |    2    |    1    |    0    
 * ---------|---------|---------|---------|---------|---------|---------|---------
 *     1    | CONFIG2 | CONFIG1 | CONFIG0 |    1    |BOOTSIZE2|BOOTSIZE1|BOOTSIZE0
 * ---------|---------|---------|---------|---------|---------|---------|---------
 */
// <h> Boot Control Option Byte (C4H)
//     <o.4..7> Start area selection             <9=> Start from boot area
//                                               <10=> Start from extend flash area
//                                               <11=> Start from RAM area
//                                               <15=> Start from main flash area
//     <o.0..3> Boot area size setting           <9=> Main Flash 252k(00000-3EFFFH)  Boot Area 4k(3F000-3FFFFH)
//                                               <10=> Main Flash 252k(00000-3DFFFH)  Boot Area 8k(3E000-3FFFFH)
//                                               <11=> Main Flash 252k(00000-3BFFFH)  Boot Area 16k(3C000-3FFFFH)
//                                               <15=> Main flash 256k(00000-3FFFFH) 
// </h>
    0xFF,
