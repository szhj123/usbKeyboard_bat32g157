...
//#include "platform.h"
#include "usb_basic_define.h"
#include "usb_basic_mini_config.h"
#include <stdint.h>

#ifndef USB_BASIC_MINI_IF_H
#define USB_BASIC_MINI_IF_H
...
} usb_cfg_t;					// XXX cinfiguration type define in "usb_basic_mini_if.h"
...
} usb_ctrl_t;					// XXX control type define in "usb_basic_mini_if.h"
...
} usb_status_t;			// XXX USB status type in "usb_basic_mini_if.h"
 ...
 ******************************************************************************/
extern usb_err_t       USB_Open (usb_ctrl_t *p_ctrl, usb_cfg_t *p_cfg);
extern usb_err_t       USB_Close (void);
extern usb_err_t       USB_Read (usb_ctrl_t *p_ctrl, uint8_t *p_buf, uint32_t size);
extern usb_err_t       USB_Write (usb_ctrl_t *p_ctrl, uint8_t *p_buf, uint32_t size);
extern usb_err_t       USB_Stop (usb_ctrl_t *p_ctrl, uint16_t type);
extern usb_err_t       USB_Suspend (void);
extern usb_err_t       USB_Resume (void);
extern usb_err_t       USB_VbusSetting (uint16_t state);
extern usb_err_t       USB_PullUp(uint8_t state);
extern usb_err_t       USB_GetInformation (usb_info_t *p_info);
extern usb_err_t       USB_PipeRead (usb_ctrl_t *p_ctrl, uint8_t *p_buf, uint32_t size);
extern usb_err_t       USB_PipeWrite (usb_ctrl_t *p_ctrl, uint8_t *p_buf, uint32_t size);
extern usb_err_t       USB_PipeStop (usb_ctrl_t *p_ctrl);
extern usb_err_t       USB_GetUsePipe (uint16_t *p_pipe);
extern usb_err_t       USB_GetPipeInfo (usb_ctrl_t *p_ctrl, usb_pipe_t *p_info);
extern usb_status_t    USB_GetEvent (usb_ctrl_t *p_ctrl);
extern uint32_t        USB_GetVersion (void);

#endif /* USB_BASIC_MINI_IF_H */
